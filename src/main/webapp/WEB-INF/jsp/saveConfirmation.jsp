<%-- 
    Document   : saveConfirmation
    Created on : 19-Sep-2010, 15:58:01
    Author     : Miroslav
--%>
...
<html>
    <head>
        ...
        <title>HafTrust Register Verifier - Save Confirmation Page</title>
    </head>
    <body>

        <h1 align="center">Verifier Registration - Save Confirmation</h1>
        <hr size="5">
        <p align="center">
            <b>Verifier Candidate details have been saved successfully</b>
        </p>
        <table border="0" align="center">
            <tbody>
                <tr>
                    <td>ID : </td>
                    <td><c:out value="${rvBean.idVerifier}"></c:out> </td>
                </tr>
                <tr>
                    <td>Email : </td>
